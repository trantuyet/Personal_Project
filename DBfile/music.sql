...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 10, 2020 at 07:03 PM
...
CREATE TABLE `collection` (
  ...
  `collection_title_id` int(11) NOT NULL,
...
(4, 'Bhavesh', 'bhaveshsingh022000@htmail.com', 'Bhavesh@2017', 942551982);
...
--
ALTER TABLE `collection`
  MODIFY `collection_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;

--
-- AUTO_INCREMENT for table `collection_title`
--
ALTER TABLE `collection_title`
  MODIFY `collection_title_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
